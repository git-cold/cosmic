    ...
    @if($articles->isNotEmpty())
        <div class="cats">
            <div class="formulaire">
                ...
                <nav id="slide-menu">
                    <form action="{{ url("/categorie/$cat->id") }}" method="post" id="priceFilterForm">
                        @csrf
                        <div class="price-slider-container">
                            ...
                            <div class="lesDeuxBoutons">
                                ...
                                <a href="{{ url("/categorie/$cat->id") }}"><button class="btnReset blue-text">Réinitialiser</button></a>
                            </div>
                        </div>
                    ...
                    <div class="carousel-container">
                        ...
                        @empty
                            <div class="filter-not-found">
                                ...
                                <a href="{{ url("/categorie/$cat->id") }}"><button class="button-continue-search">Continuer à chercher</button></a>
                            </div>
                        @endforelse
                    </div>
